"""Static YourMT3 architecture configuration; no training or device side effects."""
...
T5_BASE_CFG = {
    "google/t5-v1_1-small": {
        ...
        "d_ff": 1024,  # size of the intermediate feed forward layer in each T5Block. Can be overwrten by ff_widening_factor in model_cfg.
